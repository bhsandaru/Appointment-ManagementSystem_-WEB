          ...
          <CssBaseline />       
            ...
            <Box sx={{ flexGrow: 1,maxWidth: 2000, height: 850}} >
             ...
             <CardContent >
              ...
              <a href="./AdminStudentDetails20"><Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>20 Batch
               </Button>  </a>
              </Stack>
              </div>
              <div>
                ...
                <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
                <a href="./AdminStudentDetails20"><Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>21 Batch
                 </Button> </a> 
                </Stack>
                </div>
              ...
              <div>
                ...
                <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
                <a href="./AdminStudentDetails20"><Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>22 Batch
                 </Button>  </a>
                </Stack>
                </div>
                ...
                <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
                <a href="./AdminStudentDetails20"><Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>23 Batch
                </Button>  </a>
                </Stack>
                </div>
