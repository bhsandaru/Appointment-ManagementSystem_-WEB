            ...
            <Box sx={{ flexGrow: 1,maxWidth: 2000, height: 850}} >
             ...
             <div>
              ...
              <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
               <a href ="/AdminInstructorDetailsCivil" > <Button variant='contained' style={buttonStyle}  sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>Department of Civil and Environmental Engineering
               </Button>  </a>
              </Stack>
              </div>
              <div>
                ...
                <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
                <a href ="/AdminInstructorDetailsElec" ><Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>Department of Electrical and Environmental Engineering
                </Button>  </a>
                </Stack>
                </div>
                ...
                <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
                <a href ="/AdminInstructorDetailsMechanical" > <Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>Department of Mechanical and Manufacturing Engineering
                 </Button>  </a>
                </Stack>
                </div>
