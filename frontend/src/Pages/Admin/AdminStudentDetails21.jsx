            ...
            <Box sx={{ flexGrow: 1,maxWidth: 2000, height: 850}} >
             ...
             <CardContent >
              ...
              <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
               <Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>Osanda Keshan
               </Button>  
              </Stack>
              </div>
              
              <div>
              <center><Button variant='contained' style={buttonStyle1} sx={{ width: 500 , alignItems:"center",textalignment:"center", backgroundColor:"#46B7C7"}}>Add Student
             </Button> </center> 
             </div>
