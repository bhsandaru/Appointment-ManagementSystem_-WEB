            ...
            <Box sx={{ flexGrow: 1,maxWidth: 2000, height: 850}} >
             ...
             <CardContent >
              ...
              <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
                <a href ="/AdminLectures" ><Button variant='contained' style={buttonStyle} sx={{ width: 500 , alignItems:"left",textalignment:"left", backgroundColor:"#46B7C7"}}>Lectures</Button></a>  
              </Stack>
              </div>
            <div>
            <Stack spacing={2} direction="row" sx={{ width: '450' }} alignItems={"left"}>
